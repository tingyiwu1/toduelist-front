...
interface CommitItemProps {
    commit: Commit
    editCommit: (commitId: string, description: string, hours: number) => Promise<void>
    deleteCommit: (commitId: string) => Promise<void>
}

const CommitItem = React.memo(({ commit, editCommit, deleteCommit }: CommitItemProps) => {
            ...
            <div className=''>
                {edit ?
                    ...
                    <div>
                        ...
                        <Menu>
                            <Menu.Button><EllipsisHorizontalIcon className="w-5 h-5" /></Menu.Button>
                            <Menu.Items>
                                <Menu.Item>
