...
const CreateCommitForm = ({ createCommit }: CreateCommitFormProps) => {
    ...
    return (
        <>
            <input type="text" value={description} placeholder="Add commit" onChange={e => setDescription(e.target.value)} />
            <input type="number" value={hours} min="0" placeholder="hrs" onChange={e => setHours(e.target.value)} />
